...
import sepoliaLogo from "../../assets/img/sepolia-logo.png";
                    ...
                    <button className="flex flex-row items-center bg-gray-700 hover:bg-indigo-900 py-1.5 px-4 mr-2 rounded-2xl lowercase">
                        {
                            !correctNetwork ? (
                                <IoWarningOutline
                                    className="text-2xl"
                                    title="Current network of your network doesn't match the correct network"
                                />
                            ) : networkId == 1 ? (
                                <div title="Custom tooltip text"
                                    data-tip data-for="ethTooltip"
                                >
                                    <img src={ethLogo} className="h-6" alt="Ethereum Logo"></img>
                                    <ReactTooltip id="ethTooltip" place="top" effect="solid">
                                        Custom tooltip text
                                    </ReactTooltip>
                                </div>
                            ) : networkId == 11155111 ? (
                                <div title="Custom tooltip text">
                                    <img src={sepoliaLogo} className="h-6" alt={sepoliaLogo}></img>
                                </div>
                            ) : null
                        }
